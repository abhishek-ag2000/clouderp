...
# list1 =[[creation_date,name,bal_nature,opening balance],
#  		  [creation_date,name,bal_nature,opening balance],
#  		[creation_date,name,bal_nature,opening balance]]
...
total_balance(ls,j,allname(lspre))
