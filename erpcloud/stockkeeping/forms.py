...
class Purchase_form(forms.ModelForm):
	class Meta:
		model  = Purchase
		fields = ('User','Company','date','Address','billname','GSTIN','PAN','State','Contact','DeliveryNote','Supplierref','Mode', 'ref_no', 'Party_ac', 'purchase', 'Total_Purchase')
		widgets = {
            'date': DateInput(),
        }
...
class Stock_Totalform(forms.ModelForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['gst_rate_p'].widget.attrs = {'class': 'form-control',}
